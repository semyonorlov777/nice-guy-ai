...
Личная страница «Мои путешествия» — интерактивная карта посещённых регионов России, Таиланда и Грузии. На странице `/travel` две ссылки-карточки: основная (HTML на Leaflet, файл `public/travel/map.html`) и альтернативная (SVG-версия, файл `public/travel/map.svg`). Single-user, без БД, без авторизации.

-- =============================================================
-- Fix razgovorny-gipnoz program-level: system_prompt, author_chat_system_prompt,
-- free_chat_welcome, author_chat_welcome.
--
-- Root causes (see docs/runbooks/chat-message-formatting.md):
--   Bug 1 — AI in free chat and inside themes (rapport / suggestions /
--           strategy / awareness / trance) produces no «ёлочки» because
...
--   Bug 2 — Author chat (AI as Igor Vagin) also has no «ёлочки» and no
...
--      (with «не вопросы к тебе (к Вагину)» instead of «к AI»).
--   3. APPEND 3 starter «ёлочки» to programs.free_chat_welcome

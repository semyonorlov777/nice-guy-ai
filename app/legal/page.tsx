    ...
    <div className="legal-page">
      <div className="legal-inner">
        ...
        <div className="legal-section">
          ...
          <p className="legal-p">
            2.1. Исполнитель предоставляет Пользователю доступ к онлайн-платформе «Книжный Спарринг» —
            онлайн-тренажёрам по книгам по саморазвитию (далее — «Сервис»), размещённой в сети Интернет.
          </p>
          <p className="legal-p">
            2.2. Сервис включает: доступ к структурированным упражнениям из книг, взаимодействие с
            Системой (чат-бот), формирование персонального психологического портрета, свободный
            чат по тематике книги.
          </p>
          <p className="legal-p">
            2.3. Сервис НЕ является медицинской, психологической или психотерапевтической помощью.
            Система выступает в роли методологического помощника и не заменяет квалифицированного
            специалиста.
          </p>
        </div>
        ...
        <div className="legal-section">
          ...
          <p className="legal-p">
            ...
            диалогов с Системой) исключительно для целей оказания услуг.
          </p>
          <p className="legal-p">
            7.2. Содержание диалогов Пользователя с Системой является конфиденциальным.
        ...
        <div className="legal-section">
          ...
          <p className="legal-p">
            8.2. Система использует искусственный интеллект для генерации ответов. Исполнитель
            не несёт ответственности за точность, полноту и применимость рекомендаций Системы.
          </p>
          <p className="legal-p">

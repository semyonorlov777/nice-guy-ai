    ...
    <div className="demo-picker">
      <div className="demo-picker__inner">
        ...
        <p className="demo-picker__lead">
          ...
          <strong>на 9-й секции из 10</strong>. До начала диалога — 3+ действий.
          Ниже — варианты, как сделать так, чтобы человек начал писать сразу,
        ...
        <section id="why" className="demo-why">
          ...
          <div className="demo-principle">
            ...
            <div className="demo-principle__row">
              ...
              долго листать. До начала диалога — 3+ действий (клик «начать» →
              прокрутка → клик в поле → печать). Это главный провал текущей
              версии. По обоим исследованиям (Gemini и Claude) — единогласное
              решение. Отдельная кнопка «Начать разбор» в варианте A тоже убрана:
              она делала чат «вторым шагом» вместо первого. Само поле ввода — и
          ...
          <div className="demo-principle">
            ...
            <div className="demo-principle__row">
              ...
              не «универсальный помощник», а тренажёр по конкретной книге.
              Аудитория приходит именно по знакомству с книгой или автором —
              это её единственная точка опоры. Без обложки и регалий первый
              экран превращается в «ещё одну техно-игрушку». Так был убран
              вариант «чат во весь экран» (без обложки и автора).
            </div>
            <div className="demo-principle__row">
              <span className="demo-principle__label">Как</span>
          ...
          <div className="demo-principle">
            <div className="demo-principle__title">8. Приветствие чата — короткое, без слов «проводник» / «помощник» / «AI»</div>
            <div className="demo-principle__row">
              <span className="demo-principle__label">Почему</span>
              Отдельный проектный принцип: слова «AI» и «ИИ» в видимых
              текстах не используем — они обесценивают премиальный продукт
              (читается как «ещё один чат-бот»). Слова «проводник», «помощник»
              в духовно-эзотерическом тоне тоже не подходят — отталкивают ЦА
              мужчин 25–45 (звучит как коучинг). «Тренажёр» — рабочий,
              инструментальный тон. И не дублируем регалии автора, они уже
              видны слева.
            </div>
            <div className="demo-principle__row">
              <span className="demo-principle__label">Как</span>
              «Привет. Я тренажёр по методу Роберта Гловера. Расскажи одну
              ситуацию: где ты последний раз сказал „да", когда хотел сказать
              „нет"?» Две короткие строки, конкретный вопрос.
            </div>
          </div>
          ...
          <div className="demo-principle">
            ...
            <div className="demo-principle__row">
              <span className="demo-principle__label">Как</span>
              Под приветствием тренажёра — три кнопки: «Согласился, когда
              хотел отказаться», «Промолчал, когда был не согласен», «Сам не
              понимаю, чего хочу». Реальные ситуации мужчины 25–45.
            </div>
          </div>
          ...
          <div className="demo-principle">
            ...
            <div className="demo-principle__row">
              <span className="demo-principle__label">Почему</span>
              По Claude Research (14 из 16 проверенных сайтов с похожим
              интерфейсом): «Войти» всегда отдельно от основного действия.
              Кто уже зарегистрирован — должен сразу её найти. В Hero «Войти»
          ...
          <ul className="demo-why__list">
            ...
            <li>
              <strong>Слова «AI» и «ИИ» в видимых текстах.</strong>{" "}
              Отдельный проектный принцип: они обесценивают премиальный продукт
              (читается как «ещё один чат-бот»). В приветствии тренажёра нет
              ни «AI», ни «ИИ» — есть просто «тренажёр по методу Гловера».
            </li>
            <li>
              <strong>Роботизированные приветствия типа «Привет, я модель ИИ…»</strong>{" "}
              — разрушают доверие в первой же строке.
            </li>
            <li>
            ...
            <li>
              <strong>Длинное приветствие с подробными регалиями автора.</strong>{" "}
              Раньше было: «Я цифровой проводник по методу Роберта Гловера —
              клинического психотерапевта, который 30 лет лечит мужчин от
              синдрома „хорошего парня". Я обучен на его 46 упражнениях и
              сотнях разборов из практики…» — длинно и дублирует блок автора
              слева. Заменили на короткое: «Привет. Я тренажёр по методу
              Роберта Гловера.»
            </li>
            <li>

...
const HERO_SUB =
  "46 упражнений, которые превращают понимание книги в реальный навык. Это AI-проводник по методу, а не сам автор.";
const AUTHOR_NAME = "Роберт Гловер · «No More Mr. Nice Guy»";
const AUTHOR_CREDENTIALS =
  "Тираж 2+ млн копий · 20+ языков · Goodreads 4,04 из 5 (24 650 оценок)";
...
// сразу даёт конкретный первый вопрос вместо абстрактного «расскажи о себе».
const HERO_WELCOME =
...
// «Ёлочки» — конкретные ситуации, а не философские темы.
      ...
      <section className="demo-why-block">
        <div className="demo-why-block__inner">
          ...
          <ul className="demo-why-block__list">
            <li>Слева — обложка книги и автор с регалиями (зацепка для тех, кто знает Гловера) + одна строка с цифрой про сегодняшних пользователей. Никакого мелочного «без регистрации, 990 ₽».</li>

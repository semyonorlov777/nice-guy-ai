...
// Приветствие — короткое. Слово «AI» в видимых текстах не используем
// (проектный принцип: AI/ИИ обесценивают премиальный продукт).
const HERO_WELCOME =
  ...
  return (
    <div className="landing-v3 demo-landing">
      ...
      {/* Мини-шапка: «Войти» в правом верхнем углу страницы (Claude Research,
          14 из 16 проверенных сайтов с похожим интерфейсом). Вне Hero-карточки,
          чтобы не конкурировать с полем ввода справа за внимание. */}
      ...
      <section className="demo-why-block">
        <div className="demo-why-block__inner">
          ...
          <ul className="demo-why-block__list">
            ...
            <li>«Войти» — отдельно сверху страницы, не путается с основным действием. Подходит, если веришь, что первый ответ сам продаст программу.</li>
          </ul>

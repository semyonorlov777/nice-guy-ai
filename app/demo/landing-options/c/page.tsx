      ...
      <section className="demo-why-block">
        <div className="demo-why-block__inner">
          ...
          <ul className="demo-why-block__list">
            <li>Чат — единственный заметный элемент. Никакой кнопки рядом, чтобы не отвлекать. Главное действие — просто начать писать.</li>
            <li>Имя автора не выделяем. Вместо «доктор Гловер» — строка «тираж 2 млн копий, 20+ языков». В России Гловера знают примерно 5%, имя само по себе ничего не даёт. А цифры — даже если автора не знают.</li>
            <li>Не список обещаний, а одна строка с цифрами, которые можно проверить: оценка 4,04 на Goodreads и 24 650 отзывов, тест из 35 вопросов.</li>
          </ul>

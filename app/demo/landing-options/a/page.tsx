...
const HERO_QUICK_REPLIES: QuickReplyInput[] = [
  { text: "Боюсь конфликтов и часто уступаю", type: "default" },
  { text: "Делаю всё для партнёрши, но чувствую себя пустым", type: "default" },
  { text: "Хочу пройти тест на паттерны «славного парня»", type: "default" },
];
